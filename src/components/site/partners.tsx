...
export function Partners({ dict = ruDict }: { dict?: Dictionary } = {}) {
  return (
      ...
      <div className="container-page py-16 sm:py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-5">
            <h2 className="font-heading text-[26px] sm:text-[36px] md:text-[44px] lg:text-[52px] leading-[1.1] sm:leading-[1.05] tracking-[-0.025em] text-brand whitespace-pre-line">
              {dict.partners.headline}
            </h2>
