...
export function Showreel() {
  ...
  return (
    <button
      ...
      className="group relative block w-full overflow-hidden rounded-[20px] sm:rounded-[28px] aspect-[16/9] ring-1 ring-white/10 cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent-coral"
    >
      <video
        ref={videoRef}
