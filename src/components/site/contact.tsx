  ...
  return (
    <section id="contact" className="relative bg-white">
      <div className="container-page py-20 lg:py-24">
        <div
          className="rounded-[28px] px-8 sm:px-14 lg:px-20 py-16 lg:py-24 text-white relative overflow-hidden"
          style={{
            background:
        ...
        >
          ...
          <div className="relative max-w-3xl">
            <h2 className="font-heading text-[44px] sm:text-[64px] leading-[1.02] tracking-[-0.025em]">
              Начнём планировать?
            </h2>
            <p className="mt-7 text-[16px] leading-relaxed text-white/80 max-w-lg">
            ...
            <div className="mt-10 space-y-3">
              <a
                ...
                className="block font-heading text-[40px] sm:text-[52px] leading-none tracking-[-0.02em] hover:text-accent-coral transition-colors"
              >
                +7 (921) 410-21-21
              </a>
              <a
        ...
        <p className="mt-10 text-[14px] text-body max-w-2xl">
