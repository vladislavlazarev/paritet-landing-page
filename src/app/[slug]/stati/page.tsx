...
export default async function LocaleBlogIndexPage(
  ...
  const breadcrumbs = breadcrumbJsonLd([
    { name: dict.blogPage.breadcrumbHome, url: localizedAbsoluteUrl(locale, "/") },
    { name: dict.blogPage.breadcrumbBlog, url: localizedAbsoluteUrl(locale, "/stati") },
  ]);
      ...
      <main className="flex-1">
        ...
        <section className="bg-white">
          <div className="container-page py-12 sm:py-16 lg:py-20">
            <p className="mb-8 max-w-3xl text-[14px] leading-relaxed text-muted-fg border-l-2 border-accent-coral/40 pl-4">
                ...
                <li key={post.slug}>
                  ...
                  >
                    ...
                    <div className="px-6 sm:px-7 py-5 sm:py-6">
                      ...
                      {post.description && (
                        <p lang="ru" className="mt-3 text-[14px] leading-relaxed text-body line-clamp-3">
                          {post.description}
                        </p>
                      )}
                    </div>
